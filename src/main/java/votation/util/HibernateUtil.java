	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL, "jdbc:mysql://localhost:3306/votation?serverTimezone=UTC");
...
//				settings.put(Environment.HBM2DDL_AUTO, "create");
				...
				configuration.addAnnotatedClass(UsuarioVoto.class);
